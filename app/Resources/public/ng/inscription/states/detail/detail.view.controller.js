 ...
 */
sygeforApp.controller('InscriptionDetailViewController', ['$scope', '$state', '$utils', '$dialog', 'data', 'inscriptionStatusList', 'presenceStatusList', function($scope, $state, $utils, $dialog, data, inscriptionStatusList, presenceStatusList) {
    $scope.inscription = data.inscription;
    $scope.latestInscriptions = data.latestInscriptions;
