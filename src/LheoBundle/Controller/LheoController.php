...
namespace LheoBundle\Controller;
...
use LheoBundle\Writer\RdfWriter;
use LheoBundle\Writer\XmlWriter;
...
class LheoController extends Controller
{
     ...
     * @ParamConverter("organization", class="SygeforCoreBundle:AbstractOrganization", options={"code" = "code"})
     * @Template()
     */
    public function rdfLheoAction(AbstractOrganization $organization)
    {
     ...
     * @Template
     */
    public function xmlLheoAction(AbstractOrganization $organization)
    {
    ...
    {
        $pathJsonFile            = file_get_contents('../src/LheoBundle/Resources/config/organizationSpecificities.json');
        ...
        $orgKeys          = array('name', 'address', 'zip', 'city', 'phoneNumber', 'email', 'website');
