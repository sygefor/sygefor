...
use Sygefor\Bundle\UserBundle\Security\Authorization\AccessRight\AllOrganizationUserAccessRight;
...
class AllOrganizationUserAcessRightTest extends \PHPUnit_Framework_TestCase
{
    public function testAccessRightShouldReturnCorrectLabel()
    {
        ...
        $this->assertEquals("Gestion des utilisateurs de toutes les URFIST",$AccessRight->getLabel());
    }
