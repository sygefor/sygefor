...
sygeforApp.config(["$listStateProvider", "$dialogProvider", "$widgetProvider", function($listStateProvider, $dialogProvider, $widgetProvider) {
    ...
    $listStateProvider.state('report', {
        url: "/report?q",
        templateUrl: "activityreportbundle/report.html",
            ...
            training: {
                ...
                states: {
                    summaries: {
                        url: "/summaries",
                        controller:"ActivityReportController",
                        templateUrl: "activityreportbundle/training/summaries.html"
                    },
                    crosstabs: {
                        url: "/crosstabs",
                        controller:"ActivityReportController",
                        templateUrl: "activityreportbundle/training/crosstabs.html"
                    },
                    listings: {
                        url: "/listings",
                        controller:"ActivityReportController",
                        templateUrl: "activityreportbundle/training/listings.html"
                    }
                }
            },
            meeting: {
                ...
                states: {
                    summaries: {
                        url: "/summaries",
                        controller:"ActivityReportController",
                        templateUrl: "activityreportbundle/meeting/summaries.html"
                    },
                    crosstabs: {
                        url: "/crosstabs",
                        controller:"ActivityReportController",
