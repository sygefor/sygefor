...
class PlaceType extends VocabularyType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('embed_map', 'textarea', array (
            ...
            'required'    => false,
            'attr' => array(
                'placeholder' => 'Exemple : <iframe src="https://www.google.com/maps/embed?pb=Urfist+Paris" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>'
            )
        ));
    }
