...
class ConvertTypeBatchOperation extends AbstractBatchOperation
{
    ...
    /**
     * to get new entity type class
     * @var TrainingTypeRegistry $trainingTypeRegistry
     */
     ...
     */
    public function __construct(EntityManager $em, SecurityContext $securityContext, TrainingTypeRegistry $trainingTypeRegistry,
    ...
    public function execute(array $idList = array(), array $options = array())
    {
        ...
        $entities = SemesteredTraining::getTrainingsByIds($idList, $this->em, [$type, 'meeting']);
