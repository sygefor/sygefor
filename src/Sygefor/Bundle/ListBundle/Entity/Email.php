...
namespace Sygefor\Bundle\ListBundle\Entity;
...
class Email
{
    ...
    /**
     * @var User $userFrom
     * @ORM\ManyToOne(targetEntity="Sygefor\Bundle\UserBundle\Entity\User")
    ...
    /**
     * @var $trainer
     * @ORM\ManyToOne(targetEntity="Sygefor\Bundle\TrainerBundle\Entity\Trainer")
     * @ORM\JoinColumn(nullable=true, onDelete="CASCADE")
     */
    protected $trainer;
    ...
    /**
     * @var $session
     * @ORM\ManyToOne(targetEntity="Sygefor\Bundle\TrainingBundle\Entity\Session")
     * @ORM\JoinColumn(nullable=true, onDelete="SET NULL")
     */
    protected $session;
