 ...
 * Time: 10:22.
 */
namespace Sygefor\Bundle\CoreBundle\Tests\BatchOperations;

//use Doctrine\DBAL\Query\QueryBuilder;

use Sygefor\Bundle\CoreBundle\BatchOperations\CSVBatchOperation;
        ...
        $csvBatch->setOptions(
            array(
                'fields' => array(
                    ...
                    'organization.name' => array('label' => 'Centre'),
                ),
            )
        );
        ob_start();
