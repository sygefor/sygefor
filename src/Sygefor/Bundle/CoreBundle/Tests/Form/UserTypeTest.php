...
class UserTypeTest extends TypeTestCase
{
    ...
    public function testFormSavesData($data)
    {
        ...
        $accessRightRegistry = $this->getMockBuilder('Sygefor\Bundle\CoreBundle\AccessRight\AccessRightRegistry', null, $container)
            ->disableOriginalConstructor()
            ->getMock()
    ...
    public function createTestEntityManager()
    {
        ...
        $config->setEntityNamespaces(array('SygeforCoreBundle' => 'Sygefor\\Bundle\\CoreBundle\\Entity'));
