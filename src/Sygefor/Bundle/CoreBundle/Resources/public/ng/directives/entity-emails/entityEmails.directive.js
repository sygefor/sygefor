    ...
    return {
        ...
        templateUrl: function(elem, attr) {
            if (attr.trainee && !attr.session) {
                return 'traineebundle/trainee/states/detail/partials/emails.html';
            }
            else if (!attr.trainee && attr.session) {
                return 'trainingbundle/session/states/detail/partials/emails.html';
            }
            else if (attr.trainer) {
                return 'trainerbundle/states/detail/partials/emails.html';
            }
           else if (attr.trainee && attr.session) {
