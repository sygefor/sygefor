...
/**
 * Class LoadDiverseTraining
 * @package Sygefor\Bundle\TrainingBundle\DataFixtures\ORM
 */
class LoadDiverseTraining extends AbstractTestDataFixture
{
    /**
    ...
    public function doLoad(ObjectManager $manager) {
        ...
        $populator->addEntity('Sygefor\Bundle\TrainingBundle\Entity\DiverseTraining', 50, array(
            ...
            'organism' => function() use ($faker) { return $faker->sentence($nbWords = 1); },
            'variousAction' => function() use ($manager) {
                    $variousAction = $manager->getRepository('Sygefor\Bundle\TrainingBundle\Entity\Term\VariousAction')->findAll();
                    $size = count($variousAction);
                    return $variousAction[rand(0, $size - 1)];
                },
